 ...
 *
 */
public class XorBitSetAttributeRetriever implements QidAttributeVisitor {

	private XorBitSetAttribute bsAttribute;

	public XorBitSetAttributeRetriever() {
	...
	public Optional<XorBitSetAttribute> getXorBitSetAttribute() {
