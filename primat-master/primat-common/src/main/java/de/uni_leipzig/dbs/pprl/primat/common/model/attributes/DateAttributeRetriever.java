 ...
 *
 */
public class DateAttributeRetriever implements QidAttributeVisitor {

	private DateAttribute dateAttribute;

	public DateAttributeRetriever() {
		this.dateAttribute = null;
	}

	@Override
	public void visit(DateAttribute attr) {
		this.dateAttribute = attr;
	}

	public Optional<DateAttribute> getDateAttribute() {
