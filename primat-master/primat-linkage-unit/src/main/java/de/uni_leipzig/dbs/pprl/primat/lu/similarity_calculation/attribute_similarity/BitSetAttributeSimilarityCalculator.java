 ...
 *
 */
public class BitSetAttributeSimilarityCalculator extends AttributeSimilarityCalculator<BitSetAttribute, BitSet> {

	public BitSetAttributeSimilarityCalculator(List<SimilarityFunction<BitSet>> list) {
		super(list);
	}
