 ...
 *
 */
public class IntegerSetAttributeSimilarityCalculator
	extends AttributeSimilarityCalculator<IntegerSetAttribute, Set<Integer>> {

	public IntegerSetAttributeSimilarityCalculator(List<SimilarityFunction<Set<Integer>>> list) {
		super(list);
	}
