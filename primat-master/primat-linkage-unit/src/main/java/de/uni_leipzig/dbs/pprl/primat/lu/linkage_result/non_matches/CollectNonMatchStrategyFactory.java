 ...
 * @param  <T>
 */
public class CollectNonMatchStrategyFactory<T extends Linkable> implements NonMatchStrategyFactory<T> {

	public CollectNonMatchStrategyFactory() {
	}

	@Override
	public NonMatchStrategy<T> createNonMatchStrategy() {
		return new CollectNonMatchStrategy<T>();
	}
}