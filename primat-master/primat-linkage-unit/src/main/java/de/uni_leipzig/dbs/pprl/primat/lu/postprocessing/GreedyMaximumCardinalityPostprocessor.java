...
/**
 * ---> Maximal, maybe maximum
 * 
 * @author mfranke
 *
 */
public class GreedyMaximumCardinalityPostprocessor<T extends Linkable> extends JGraphTPostprocessor<T> {

	@Override
	protected MatchingAlgorithm<Linkable, SimilarityVector> getMatchingAlgorithm(SimilarityGraph<T> graph) {
		return new GreedyMaximumCardinalityMatching<Linkable, SimilarityVector>(graph.getGraph(), false);
	}

	@Override
	public String toString() {
		return "Greedy Maximum Cardinality";
	}
