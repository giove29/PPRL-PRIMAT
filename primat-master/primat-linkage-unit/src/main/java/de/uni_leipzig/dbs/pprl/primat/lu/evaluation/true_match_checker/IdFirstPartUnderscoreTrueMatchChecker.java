 ...
 *
 */
public class IdFirstPartUnderscoreTrueMatchChecker implements TrueMatchChecker {
	...
	public boolean isTrueMatch(Record left, Linkable right) {
		...
		try {
			final String firstPartLeft = idLeft.split("_")[0];
			final String firstPartRight = idRight.split("_")[0];
			return firstPartLeft.equals(firstPartRight);
		}
