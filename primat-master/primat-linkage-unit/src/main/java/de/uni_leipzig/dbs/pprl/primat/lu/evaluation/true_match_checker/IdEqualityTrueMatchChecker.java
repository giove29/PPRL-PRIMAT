 ...
 *
 */
public class IdEqualityTrueMatchChecker implements TrueMatchChecker {

	public IdEqualityTrueMatchChecker() {
	}

	@Override
	public boolean isTrueMatch(Record left, Linkable right) {
		return left.getGlobalIdentifier().equals(right.getGlobalIdentifier());
	}
}