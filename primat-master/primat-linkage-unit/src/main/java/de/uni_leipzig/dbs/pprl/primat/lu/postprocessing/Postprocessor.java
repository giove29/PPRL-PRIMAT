 ...
 *
 */
public interface Postprocessor<T extends Linkable> {

	default LinkageResultPartition<T> clean(LinkageResultPartition<T> matches) {
		this.clean(matches.getMatchStrategy());
		return matches;
	}
