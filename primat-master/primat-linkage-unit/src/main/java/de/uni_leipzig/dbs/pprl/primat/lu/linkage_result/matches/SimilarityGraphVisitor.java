 ...
 * @param  <T>
 */
public class SimilarityGraphVisitor<T extends Linkable> implements MatchStrategyVisitor<T> {

	private SimilarityGraph<T> simGraph;

	public SimilarityGraphVisitor() {
		this.simGraph = null;
	}

	public void visit(SimilarityGraphMatchStrategy<T> simGraphMatchStrat) {
		this.simGraph = simGraphMatchStrat.getSimilarityGraph();
	}
