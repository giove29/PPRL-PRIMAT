 ...
 *
 */
public class StringAttributeSimilarityCalculator extends AttributeSimilarityCalculator<StringAttribute, String> {

	public StringAttributeSimilarityCalculator(List<SimilarityFunction<String>> list) {
		super(list);
	}
